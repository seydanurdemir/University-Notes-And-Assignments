 ...
 */
public class TwoThreeFourTree< E extends Comparable< E>> implements SearchTree< E> {
    ...
    /**
     * Method to insert a new value into a node. Pre: node.data[index - 1] < o <
     * node.data[index] and node.size < Node.CAP Post: node.data[index] = o and
     * old values are moved right one. @param node The node to insert the value
     * @param index the index where th
     *
     * e
     * inserted item is to be placed @param obj The value
     *
     * t
     * o be inserted
    ...
    /**
     * The iterator class. This class provides an in-order traversal of the
     * 2-3-4 tree.
     */
    private class Iter
        ...
        /**
         * A reference to the node that contains the value that will be returned
         * by next
         */
        ...
        /**
         * The stack that contains the history back to the root. s.pop() will
         * return a Pari whose first tiem is a reference to the parent, and a
         * second item is the index of the parent.
         */
        ...
        // Constructor
        /**
         * Construct an Iter that begins with the left-most item in the tree
         */
        public Iter() {
            index = 0;
            current = root;
        ...
        /**
         * Construct an Iter that begins with the sought item in the three
         *
        ...
        /**
         * Return true if next will return a value and not throw an exception
         *
        ...
        /**
         * Return the next value from the iteration. The iterator is then
        ...
        @Override
        public void remove() {
            throw new UnsupportedOperationException("Remove from two-three trees is not supported");
        }
    }
